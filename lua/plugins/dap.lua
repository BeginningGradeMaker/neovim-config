return {
  ...
  config = function()
    ...
    vim.keymap.set('n', '<Leader>dp',
      function() dap.set_breakpoint(nil, nil, vim.fn.input('Log point message: ')) end, { desc = "Set breakpoint msg" })
    vim.keymap.set('n', '<Leader>dr', function() dap.repl.open() end, { desc = "Open console" })
    vim.keymap.set('n', '<Leader>dl', function() dap.run_last() end, { desc = "Rerun last adapter" })
