...
-- local buffer = { capabilities = capabilities }
-- lspconfig.lua_ls.setup({ capabilities = capabilities })
-- lspconfig.gopls.setup(buffer)
-- lspconfig.texlab.setup(buffer)
-- lspconfig.pyright.setup(buffer)
-- lspconfig.clangd.setup(buffer)
